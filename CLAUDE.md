...
- Nav: Standortseiten + alle Kursseiten teilen dieselbe Stadt-Nav (navwrap + topbar + mobmenu + burger). Desktop: Menüpunkte + CTA rechtsbündig (.navlinks margin-left:auto). Team = einfacher Link auf /{stadt}/team/ (Trainer-Grid je Standort inkl. Studio Manager Abdi/Bogdan, Karten verlinken auf Live-Webflow-Trainerprofile, noch nicht migriert). Kicker ohne Nummern (kein 01/02).
