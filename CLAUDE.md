...
- Open before switching on: Ruben creates the Mailchimp API key and stores it as Cloudflare secret; privacy statement needs a newsletter/Mailchimp paragraph (draft to Ruben); Mailchimp confirmation mail language/text to check in the audience settings.
