...
6. Frauen-Selbstverteidigung wird abgebaut (Entscheid Ruben 31.08.): aus ZH-Stundenplan entfernt, KEINE Frauen-Sektion bauen. Preise werden bewusst NICHT gezeigt (Sales-Prozess). Extern offen (Ruben/Rania): Josefstrasse 92 in GBP/Google Maps, local.ch, search.ch, Facebook, finde-offen.ch, firmania.ch, fitfit.fitness + alte Webflow-Seiten (FAQ, /gr/uber-uns) auf Walchestrasse 15 aktualisieren; Rania nach URL der indexierten Test-Site fragen.
