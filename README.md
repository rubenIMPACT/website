...
| `content_from_api.py`, `content_build.py` | Content sheet: fetch all tabs, then run the builders below |
| `build_team.py` | Team tab -> cards, bio overlays and coach cards everywhere |
| `ct_courses.py` | Discipline tabs -> texts of the course pages (elements marked with `data-ct`) |
