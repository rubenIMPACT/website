...
var ARR_W = [60, 80, 180, 90, 90, 50, 60, 60, 90, 70, 90, 90, 240, 200, 110, 80, 60, 360, 90, 90, 220, 120, 120, 200, 300];
...
function writeArrears(ss, rows, info, dry) {
  ...
  if (out.length) {
    ...
    sh.getRange(5, 24, out.length, 1).setRichTextValues(rich).setWrap(true); sh.getRange(5, 25, out.length, 1).setWrap(false); sh.hideColumns(25);
